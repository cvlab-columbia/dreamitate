...
if __name__ == "__main__":
    ...
    example_dir = LOCAL_DATA_DIR / "tracking_box_v3_768_448_left"
    ...
    for i in range(len(pose_list_top)):
        ...
        left_tf.append(output_pose)
    
    np.savez(os.path.join(data_dir, "video_poses_left.npz"), left_tf=np.array(left_tf))
